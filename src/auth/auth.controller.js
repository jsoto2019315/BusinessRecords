    ...
    try {
        ...
        if (email) {
            ...
            if (user) {
                ...
                res.status(200).json({
                    msg: `You have logged in successfully, welcome ${user.name}, role: ${user.role}`
                });
            } else if (admin) {
                ...
                res.status(200).json({
                    msg: `You have logged in successfully, welcome ${admin.adminName}, you have the role: ${admin.role}`
                });
            }
        }
    } catch (e) {
